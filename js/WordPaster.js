/*
	版权所有 2009-2013 荆门泽优软件有限公司 保留所有权利。
...
function PasterManager()
{
	...
	_this.Config = {
		...
		, "PostUrl"			: "http://localhost:81/hdwiki/upload.php"
		//x64
	...
	{
		HD.util.insertHtml(_this.EditorID,html);
	};
	...
	this.Init = function(kid)
	{
		...
		_this.SetEditorID(kid);
		//_this.LoadPasteEvent(kid);
	};

	//在Init()函数中调用
	_this.SetEditorID = function(id)
	{
		_this.EditorID = id;
	...
	//挂载粘贴事件
	_this.LoadPasteEvent = function(id)
	{
